...
class gsp_sndg_interface_solrPublicsearchTypeSelected_gsp extends org.grails.gsp.GroovyPage {
...
createTagBody(1, {->
printHtmlPart(2)
invokeTag('set','g',10,['var':("titleType"),'value':(" ${message(code: 'section.'+(type != null ? solrinterface.DocSolrType.getById(Integer.parseInt(type)).getKey() : 'ALL')+'.display',args: [])}")],-1)
printHtmlPart(2)
...
printHtmlPart(2)
invokeTag('set','g',12,['var':("urlImgSection"),'value':(evaluate('grailsApplication.config.section.'+(type != null ? solrinterface.DocSolrType.getById(Integer.parseInt(type)).getKey() : 'DEFAULT')+'.urlImg'))],-1)
printHtmlPart(2)
invokeTag('set','g',13,['var':("colorClass"),'value':(evaluate('grailsApplication.config.section.'+(type != null ? solrinterface.DocSolrType.getById(Integer.parseInt(type)).getKey() : 'DEFAULT')+'.color'))],-1)
printHtmlPart(2)
...
public static final long LAST_MODIFIED = 1570651609011L
