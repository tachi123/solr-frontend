...
class gsp_buscador_frontend_layoutsmain_gsp extends org.grails.gsp.GroovyPage {
...
createTagBody(2, {->
createTagBody(3, {->
expressionOut.print(grailsApplication.config.header.title)
})
...
printHtmlPart(2)
invokeTag('javascript','asset',10,['src':("jquery-2.2.4.min.js")],-1)
printHtmlPart(1)
...
printHtmlPart(1)
invokeTag('stylesheet','asset',16,['src':("poncho.min.css")],-1)
printHtmlPart(1)
...
public static final long LAST_MODIFIED = 1605994789446L
